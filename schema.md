...
Superfeedr offers the ability to subscribe to Atom and RSS feeds, but receive notifications in JSON. It's a mapping of our Atom schema. This mapping was created with the goal of being compatible with the [OSync](http://osync.org/) and [ActivityStreams](http://activitystrea.ms/) JSON schemas.
